# PLAN_MARKTPLAATS_01 — ONAFHANKELIJKE MIRROR-TOETS
...
1. publiceren zonder review proberen
2. dubbele aankoop en vertraagde webhook
3. gekocht plan openen nadat listing is gepauzeerd
4. plan wijzigen en uitleg controleren
5. beoordelen zonder aankoop proberen
6. refund en toegang controleren
7. jeugdaccount met en zonder toestemming
8. API-omzeiling voor prijs, auteurschap en entitlement
