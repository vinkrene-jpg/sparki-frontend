# PLOEGLEIDER_01 — AFHANKELIJKHEDENCHECK

## 1. Wat dit pakket nodig heeft

| Nodig | Waarom | Gevolg wanneer afwezig |
|---|---|---|
| race_intel en course-pointpoorten | Onderdeel van de complete flow | Hergebruik of gerichte uitbreiding onmogelijk; eerst als blokkade melden |
| live-location toestemming | Onderdeel van de complete flow | Hergebruik of gerichte uitbreiding onmogelijk; eerst als blokkade melden |
...
| mechaniekerkoppeling | Onderdeel van de complete flow | Hergebruik of gerichte uitbreiding onmogelijk; eerst als blokkade melden |
