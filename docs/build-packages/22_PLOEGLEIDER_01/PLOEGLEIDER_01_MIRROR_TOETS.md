# PLOEGLEIDER_01 — ONAFHANKELIJKE MIRROR-TOETS
...
1. roltoegang en teamisolatie
2. selectie en startlijst
3. gids/course points met verschillende pakketten
4. veiligheidsinformatie zonder pakketrecht
5. live locatie met en zonder toestemming
6. jeugdscenario
7. uitvaller en statuscorrectie
8. verslag/PDF en directe API
