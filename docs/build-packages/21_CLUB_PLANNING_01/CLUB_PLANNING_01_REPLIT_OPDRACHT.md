# CLUB_PLANNING_01 — REPLIT-BOUWOPDRACHT

**Onderwerp:** CLUBPLANNING EN AANWEZIGHEID  
...
1. club- of teamactiviteit plannen
2. herhalende reeks maken
3. deelnemers uitnodigen
4. aanmelden, afmelden en wachtlijst
5. ouderbevestiging voor jeugd
6. wijzigen of annuleren
7. aanwezigheid registreren
8. persoonlijke kalenderexport
9. rapportage en audittrail
...
- algemene personeelsplanning
- salaris- of urenregistratie
- nieuwe externe kalenderprovider
- volledige trainingsinhoudsbouwer
- wedstrijdintelligentie buiten planning
...
- assistent-trainer
- ploegleider
- mechanieker voor materiaalafspraken
- ouder/verzorger
- sporter
- alleen-lezen
...
1. trainer plant alleen voor bevoegd team
2. onbevoegde gebruiker kan niet wijzigen
3. herhaling maakt juiste reeks zonder dubbele events
4. wijziging verstuurt één melding per ontvanger
5. aanmelden en afmelden zijn idempotent
6. wachtlijst schuift transactioneel door
7. ouder bevestigt jeugddeelname waar vereist
8. Europe/Amsterdam tijdzonegrens klopt
9. kalenderexport bevat juiste beperkte gegevens
10. conflict wordt getoond maar niet stilzwijgend overschreven
11. annuleren bewaart audittrail
12. teamdata lekt niet
13. providerretry maakt geen dubbele kalenderitems
14. geen mockaanwezigheid
...
1. Een club kan een seizoen plannen en aanwezigheid volgen zonder databaseingrepen, dubbele meldingen of datalekken.
