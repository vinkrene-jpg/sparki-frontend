# BOUWOPDRACHT — TOEGANKELIJKHEID EN APPARAATKWALITEIT

**Code:** `TOEGANKELIJKHEID_01`  
**Uitvoerder:** Replit  
...
Maak alle bestaande kernflows aantoonbaar bruikbaar en toegankelijk op desktop, PWA, native mobiel, kleine en grote telefoons en tablet, inclusief toetsenbord, schermlezer, schaalbare tekst, contrast, focus, foutmeldingen en netwerk-/offlinegedrag.

## Scope

- WCAG 2.2 AA voor kernflows;
- toetsenbord en focus;
- schermlezerlabels en semantiek;
- contrast en niet-kleurafhankelijke status;
- tekstschaling en zoom;
- tikoppervlakken en gestures;
- oriëntatie en safe areas;
- desktop, PWA, native mobiel en tablet;
- kleine telefoon en grote telefoon;
- formulieren, foutmeldingen en validatie;
- kaarten en navigatiebediening;
- offline- en netwerkfouten;
- bewegingsreductie;
- Nederlandse taal en begrijpelijkheid;
- toegankelijkheidsteststraat;

## Buiten scope

- volledige visuele redesign;
- nieuwe productfuncties;
- ondersteuning voor verouderde browsers buiten beleid;
- medische toegankelijkheidsclaims;
...
1. alle kernflows volledig met toetsenbord.
2. zichtbare focusvolgorde logisch.
3. schermlezer leest labels en status correct.
4. contrast voldoet AA.
5. tekst op 200% blijft bruikbaar.
6. tikdoelen voldoen minimale grootte.
7. kleine telefoon toont geen desktoplayout die slechts krimpt.
8. native mobiel respecteert safe areas.
9. kaartbediening blijft bereikbaar zonder kritieke overlap.
10. foutmelding is begrijpelijk en gekoppeld aan veld.
11. offline- en netwerkfout zijn onderscheiden.
12. reduced motion wordt gerespecteerd.
13. desktop, PWA, mobiel en tablet hebben parity in functie.
14. geen merknaam als handelend onderwerp in gewone UI-zinnen.
