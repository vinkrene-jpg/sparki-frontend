...
**Volgorde:** bouwt op `SPARKI_BUILD_01` — een **technische** afhankelijkheid, geen wachtpoort. Onafhankelijke onderdelen mogen parallel.
...
**Mirror:** het antwoord op de laatste vraag is het aantal bestaande architecturen — dat getal bepaalt de migratieomvang. **F1 start direct na de F0-rapportage.** Mirror toetst F0 parallel; blijkt een bevinding onjuist, dan is dat een herstelopdracht op de betrokken lijn — geen bouwstop.
