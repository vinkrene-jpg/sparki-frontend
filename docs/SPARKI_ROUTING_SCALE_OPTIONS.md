...
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Publieke Overpass blijven gebruiken (huidig) | geen — werkt vandaag | €0 | geen | vrijwel actueel (mirror-replicatie, vertraging niet gegarandeerd) | laag: rate-limits, 10k-elementengrens, 14–98 s koud | fail-closed 422/`ROUTE_UNVERIFIABLE` bestaat al | hoog (goodwill publieke mirrors) | tientallen gebruikers, NL/VL | nu — default |
