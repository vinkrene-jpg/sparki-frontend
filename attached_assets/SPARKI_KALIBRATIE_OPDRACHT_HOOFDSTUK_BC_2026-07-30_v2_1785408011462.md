# Sparki kalibratie — opdracht: hoofdstuk B+C (Training, coaching en analyse)
...
**Scope van deze opdracht:** uitsluitend de modules Trainingen, Trainingsplan, Sparki-coaching, Coach-cockpit, Lab, gezondheid/herstel, grafieken, mentale signalen. Geen andere modules of hoofdstukken zijn onderdeel van deze opdracht.
...
```yaml
id: TRAIN_<ONDERWERP>_001
module: Training, coaching en analyse
subject: ""
...
- welk trainingsplan veilig, uitvoerbaar en doelgericht is, op basis van erkende trainingsleer-standaarden en sportwetenschappelijke bronnen voor belasting/herstel-modellen en RPE/TSS/CTL-achtige maatstaven;
- hoe ontbrekende RPE-, herstel- of vermogensdata wordt behandeld;
- het verschil tussen advies, voorstel en automatische aanpassing, expliciet per onderwerp vastgelegd, niet impliciet verondersteld;
- bewijs dat een plan logisch blijft na gemiste of extra trainingen;
- welke modellen en wetenschappelijke bronnen voor Lab/grafieken/mentale signalen worden gebruikt, en wanneer een uitkomst onzeker of niet-interpreteerbaar is.
...
- gewenste informatiedichtheid en welke grafieken echt bruikbaar zijn;
