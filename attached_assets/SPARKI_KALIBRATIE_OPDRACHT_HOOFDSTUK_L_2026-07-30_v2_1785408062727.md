# Sparki kalibratie — opdracht: hoofdstuk L (Beheer, privacy, productie en continuïteit)
...
**Scope van deze opdracht:** uitsluitend de modules Admin, privacy/account, health checks, releasegroepen, kill switches, operationele continuïteit. Geen andere modules of hoofdstukken zijn onderdeel van deze opdracht.
...
```yaml
id: BEHEER_<ONDERWERP>_001
module: Beheer, privacy, productie en continuïteit
subject: ""
...
Let op: bestaande release-readiness-normen uit het Master Plan/Build Pack zijn al vastgelegd — deze hier bevestigen met bronverwijzing, niet opnieuw uitvragen.
