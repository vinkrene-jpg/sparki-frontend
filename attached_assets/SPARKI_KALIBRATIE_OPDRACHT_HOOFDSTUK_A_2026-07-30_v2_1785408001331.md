# Sparki kalibratie — opdracht: hoofdstuk A (Start, profiel en doelen)
...
**Scope van deze opdracht:** uitsluitend de modules Onboarding, Sportpaspoort, Vandaag, Doelen. Geen andere modules of hoofdstukken zijn onderdeel van deze opdracht.
...
```yaml
id: START_<ONDERWERP>_001
module: Start, profiel en doelen
subject: ""
...
- welke gegevens minimaal nodig zijn voor betrouwbare persoonlijke begeleiding (op basis van sport-/gezondheidsbronnen op richtlijnniveau, geen individuele medische claims);
