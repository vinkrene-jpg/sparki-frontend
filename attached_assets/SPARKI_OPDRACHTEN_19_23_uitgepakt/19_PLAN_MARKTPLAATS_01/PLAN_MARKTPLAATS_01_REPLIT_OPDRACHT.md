# PLAN_MARKTPLAATS_01 — REPLIT-BOUWOPDRACHT

**Onderwerp:** TRAININGSPLANNENMARKTPLAATS  
...
Maak de volledige keten voor maken, beoordelen, publiceren, verkopen, kopen, activeren, aanpassen, beoordelen en beëindigen van trainingsplannen productiegeschikt.

Na oplevering is aantoonbaar waar:

1. trainer maakt een conceptplan
2. kwaliteitscontrole en review
3. publicatie en prijsstelling
4. zoeken en voorbeeldweergave
5. idempotente aankoop
6. activeren in kalender
7. aanpassen door sporter, trainer of AI binnen rechten
8. versiebeheer voor bestaande kopers
9. beoordeling, klacht en refund
10. verkoop pauzeren of plan intrekken zonder gekochte toegang stilzwijgend te verliezen
...
- algemene webshop of fysieke producten
- losse persoonlijke coachbegeleiding
- nieuwe betaalprovider naast bestaande Stripe/billinglaag
- medische garanties of prestatieclaims
- app-brede herbouw van de trainingbouwer
...
- trainingbouwer en kalender
- billing/Stripe en entitlement-engine
- trainer- en jeugdrollen
...
- support/admin met beperkte bevoegdheid
...
1. onvolledig plan kan niet publiceren
2. review registreert technische en inhoudelijke bevindingen
3. nieuwe versie bewaart historie en bestaande kopers
4. aankoop is idempotent bij dubbele webhook
5. koper behoudt toegang nadat verkoop wordt gestopt
6. belangrijke aanpassing toont wat verandert en waarom
7. oorspronkelijke auteur blijft zichtbaar
8. mogelijk verouderd plan toont waarschuwing zonder automatische verwijdering
9. alleen geverifieerde koper kan beoordelen
10. refund raakt geen andere aankopen
11. jeugdplan respecteert ouder- en trainerrechten
12. directe API-aanroep omzeilt geen publicatie- of aankooppoort
13. geen mockverkopen, ratings of omzet
14. desktop en mobiel doorlopen dezelfde keten
...
1. Trainer kan een plan verkopen en een sporter kan het veilig kopen, activeren en gebruiken zonder dat auteurschap, historie of rechten verloren gaan.
