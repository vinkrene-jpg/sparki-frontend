# PLOEGLEIDER_01 — REPLIT-BOUWOPDRACHT

**Onderwerp:** PLOEGLEIDER EN WEDSTRIJDTEAM  
...
Maak de volledige ploegleiderflow productiegeschikt: selectie, voorbereiding, live begeleiding, uitvallers, uitslag en wedstrijdverslag.

Na oplevering is aantoonbaar waar:

1. wedstrijd en team openen
2. selectie en reserves maken
3. startlijst bevestigen
4. technische gids en course points gebruiken
5. bevoorrading en gevaren plannen
6. warming-up en materiaalkeuze delen
7. volgauto en live locatie beheren
8. uitvaller/status registreren
9. uitslag en verslag afronden
10. PDF en teamdeling
...
- nieuwe route-engine
- algemene clubadministratie
- volledige materiaalvoorraad buiten koppeling met TEAM_MECHANIEKER_01
- ongevalideerde UCI/UEC/KNWU-categoriemapping
...
- race_intel en course-pointpoorten
- live-location toestemming
- club/teamrollen
- document/PDF-service
- mechaniekerkoppeling
...
- race_team_assignment
- race_selection
- race_startlist
- race_role_assignment
- race_instruction
- race_feed_zone
- race_hazard
- race_live_permission
- race_status_event
- race_result
- race_report
...
1. ploegleider ziet alleen toegewezen team en wedstrijden
2. selectie voorkomt dubbele startplek
3. onbekende categorie blokkeert risicovolle automatisering
4. technische gids lekt geen course points zonder Compleet-recht
5. veiligheidsinformatie blijft zichtbaar
6. live locatie zonder toestemming is leeg
7. live locatie met toestemming werkt alleen voor bevoegd account
8. minderjarige volgt ouder- en clubtoestemming
9. uitvallerregistratie is auditbaar en idempotent
10. uitslag en verslag gebruiken echte data
11. mechanieker ziet alleen materiaalrelevante informatie
12. directe API-omzeiling faalt
13. PDF bevat geen verborgen privédata
14. providerfout toont eerlijke status
15. geen mockstartlijst of uitslag
...
1. Een ploegleider kan een wedstrijd voorbereiden, live begeleiden en afronden zonder dat privacy, veiligheid of pakketrechten worden omzeild.
