# TEAM_MECHANIEKER_01 — REPLIT-BOUWOPDRACHT

**Onderwerp:** TEAMMECHANIEKER EN WEDSTRIJDMATERIAAL  
...
Maak de volledige teammechaniekerflow productiegeschikt: teamvoorraad, materiaal per renner, reparatie, uitgifte, wedstrijdcheck en terugname.

Na oplevering is aantoonbaar waar:

1. teamvoorraad registreren
2. materiaal aan renner/fiets koppelen
3. reparatieverzoek en prioriteit
4. serviceplanning
5. materiaal uitgeven en retourneren
6. defect en quarantaine
7. wedstrijdchecklist
8. reservefiets en wielsets klaarzetten
9. materiaalrapport en PDF
10. overdracht tussen mechaniekers
...
- algemene boekhouding of inkoop-ERP
- fietsfitanalyse opnieuw bouwen
- algemene individuele garage vervangen
- nieuwe IoT- of BLE-hardwarekoppelingen
- volledige ploegleiderflow
...
- teammechanieker
- hoofdmechanieker indien bestaande rol
- ploegleider
- clubbeheerder
- renner
- trainer met alleen-lezen waar toegestaan
...
- team_inventory_item
- team_bike_assignment
- team_component_assignment
- repair_request
- service_task
- inventory_issue
- inventory_return
...
1. mechanieker ziet alleen toegewezen club/teamvoorraad
2. materiaal kan niet gelijktijdig aan twee renners worden uitgegeven
3. uitgifte en retour zijn idempotent
4. defect materiaal kan niet opnieuw worden uitgegeven
5. reparatieprioriteit en historie blijven behouden
6. kilometerstand gebruikt echte activiteiten en juiste fiets
7. wedstrijdchecklist toont alleen geselecteerde renners
8. ploegleider ziet readiness maar geen onnodige onderhoudsnotities
9. renner ziet eigen materiaalstatus maar geen teamvoorraad
10. directe API-aanroep naar andere club faalt
11. PDF-materiaallijst bevat echte actuele data
12. verlies/afschrijving vereist bevoegde bevestiging
13. geen mockvoorraad
14. rollback maakt bestaand individueel materiaal niet onzichtbaar
...
1. Een teammechanieker kan materiaal en wedstrijdvoorbereiding beheren zonder dubbele uitgifte, verborgen defecten of datalek tussen teams.
