...
**Scope van deze opdracht:** uitsluitend de modules Club, teams, selecties, berichten, beheer, ploegleider/mechaniekerflows. Geen andere modules of hoofdstukken zijn onderdeel van deze opdracht.
...
- welke bestaande clubplatforms (AllUnited, Sportlink, Spond, Cyql) relevant zijn voor synchronisatie.
