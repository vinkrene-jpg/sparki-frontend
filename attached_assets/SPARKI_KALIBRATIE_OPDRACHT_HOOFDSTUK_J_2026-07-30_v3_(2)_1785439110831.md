...
**Minderjarig:** triggert automatisch de bestaande CYD-ouder-koppelingsflow vóórdat het lidmaatschap actief wordt.
...
- geen `rule_type: hard_blockage` verzwakken tot `soft_tolerance`, met name niet voor de zeven verplichte regels hierboven;
