# Sparki kalibratie — opdracht: hoofdstuk G (Materiaal, garage, fietsscan en bikefit)
...
**Scope van deze opdracht:** uitsluitend de modules Mechanieker, garage, fietsscan, materiaalcoach, voorbereid bikefit-werk. Geen andere modules of hoofdstukken zijn onderdeel van deze opdracht.
...
```yaml
id: MATERIAAL_<ONDERWERP>_001
module: Materiaal, garage, fietsscan en bikefit
subject: ""
...
- fabrikant-, model- en onderdeeldetectie, op basis van officiële fabrikantdocumentatie (handleidingen, aanhaalmomenten, recalls);
- onderhoudsintervallen op basis van gebruik en omstandigheden;
- bewijsniveau van fotoherkenning;
- fabrikantgeometrie en meetbetrouwbaarheid voor bikefit, op basis van erkende bikefit-geometrienormen.
