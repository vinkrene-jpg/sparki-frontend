# Sparki kalibratie — opdracht: hoofdstuk H (Data, koppelingen en synchronisatie)
...
**Scope van deze opdracht:** uitsluitend de modules Data Hub, Strava, Garmin/Wahoo voorbereid, bestandimport, Bluetooth-sensoren. Geen andere modules of hoofdstukken zijn onderdeel van deze opdracht.
...
```yaml
id: DATA_<ONDERWERP>_001
module: Data, koppelingen en synchronisatie
subject: ""
...
- bronprioriteit per veld, op basis van officiële API-documentatie Strava/Garmin/Wahoo en FIT/GPX/TCX-specificaties;
- deduplicatie, conflictoplossing en herkomst;
- éénmalig koppelen versus automatische achtergrondsynchronisatie;
- wat er gebeurt bij ontbrekende fabrikantsleutels of API-uitval;
- bekende rate-limit- en betrouwbaarheidsbeperkingen van elke bron.
