# Sparki kalibratie — opdracht: hoofdstuk I (Sociaal, delen, ouder en minderjarigen)
...
**Scope van deze opdracht:** uitsluitend de modules Sociaal, live locatie, rit delen, ouderomgeving, privacyrechten. Geen andere modules of hoofdstukken zijn onderdeel van deze opdracht.
...
```yaml
id: SOCIAAL_<ONDERWERP>_001
module: Sociaal, delen, ouder en minderjarigen
subject: ""
...
- fail-closed privacy- en leeftijdsregels, op basis van AVG/privacywetgeving voor minderjarigen;
...
Let op: de bestaande interne regels uit het Master Plan (progressieve geboortedatum-verificatie, ouder-kind-koppeling, 14-dagen verwijdertermijn) zijn al vastgelegd — deze hier bevestigen met bronverwijzing, niet opnieuw uitvragen.
