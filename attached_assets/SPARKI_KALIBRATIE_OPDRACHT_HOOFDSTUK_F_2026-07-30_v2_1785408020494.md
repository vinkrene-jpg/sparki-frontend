# Sparki kalibratie — opdracht: hoofdstuk F (Voeding, gewicht en hydratatie)
...
**Scope van deze opdracht:** uitsluitend de modules Voeding, seizoensdoelen en daganalyse. Geen andere modules of hoofdstukken zijn onderdeel van deze opdracht.
...
```yaml
id: VOEDING_<ONDERWERP>_001
module: Voeding, gewicht en hydratatie
subject: ""
...
- gebruik van officiële voedingsbronnen zoals NEVO en portiedata, en algemene voedingsrichtlijnen (Voedingscentrum-niveau);
- het verschil tussen algemene richtlijn en persoonlijk advies, aantoonbaar per onderwerp welk brontype de basis vormt;
