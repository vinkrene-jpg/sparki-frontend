...
- Besluit René 30-07-2026 (belofte = 0 meter + alleen echte obstakels): (1) poort telt alleen bij DOORRIJDEN — gatePassageSides: parent-way aan beide kanten van de poort gevolgd ("both"), of doorgang over way-grens via ≥2 ways elk "one"; erlangs = nooit melden; restmeters zijn meetruis, geen beleidsruimte. (2) Poort met onbekende doorgang (geen privé/verbods-tags) op een berijdbare weg wordt NIET gemeld — alleen aantoonbaar afgesloten/privé/verboden blijft (en blijft de blokkadepoort voeden).
