...
- **DT_01A-droogdraai (26 juli):** prod-cleanup-apply is nooit uitgevoerd — in prod ftp_history staat nog een ONgemarkeerde derived-rij (410 W) naast een wél gemarkeerde (331 W) plus 4 Strava-duplicaten; zelfherstel markeert dus niet gegarandeerd álle achterhaalde derived-rijen. Quarantainelijst + nooit-verwijderen-lijst: `docs/SPARKI_DATA_TRUST_DRY_RUN.json`; opschonen alleen na menselijke bevestiging via bestaand droogdraai-endpoint.
