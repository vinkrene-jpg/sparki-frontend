    ...
    <div className="rounded-2xl border border-border bg-card p-4 backdrop-blur-md">
      ...
      {bikes.length === 0 ? (
        <div className="mt-2">
          ...
          <Link
            href="/mechanieker"
            className="mt-2 inline-flex items-center gap-1.5 rounded-full border border-accent-cyan/35 px-3.5 py-1.5 text-[12px] text-accent-cyan hover:border-accent-cyan/60"
          >
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            {saved && (
              <span className="text-[12px] text-muted-foreground">Opgeslagen.</span>
            )}
          </div>
        </div>
      )}
