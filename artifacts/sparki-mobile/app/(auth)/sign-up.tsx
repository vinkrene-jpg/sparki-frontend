    ...
    >
      ...
      >
        ...
        <Text style={[styles.subtitle, { color: c.mutedForeground }]}>
          {awaitingCode
            ? "Bevestig je e-mailadres met de code die we je stuurden."
            : "Maak een account om je routes te navigeren."}
        </Text>

        {awaitingCode ? (
          <>
            <Text style={[styles.label, { color: c.mutedForeground }]}>Verificatiecode</Text>
            <TextInput
