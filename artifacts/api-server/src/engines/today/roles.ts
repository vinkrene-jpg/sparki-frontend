...
export async function orchestrateOuderToday(parentId: string): Promise<RoleTodayResult> {
  ...
  if (children.length === 0) {
    ...
    lead = {
      ...
      actions: [{ id: "consent", label: "Bekijk wat er nodig is", href: "/dashboard" }],
    ...
    lead = {
      ...
      actions: [{ id: "overview", label: "Bekijk de context", href: "/dashboard" }],
    ...
    if (todayWorkouts.length > 0) {
      ...
      lead = {
        ...
        body: todayWorkouts
          ...
          .join(" · "),
        actions: [{ id: "overview", label: "Bekijk de planning", href: "/dashboard" }],
  ...
  if (wedstrijdIds.length > 0) {
    ...
    if (r) {
      ...
      pool.push({
        ...
        actions: [{ id: "overview", label: "Bekijk de details", href: "/dashboard" }],
