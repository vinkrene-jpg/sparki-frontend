...
import seasonPlanRouter from "./season-plan";
import rhythmRouter from "./rhythm";
import basisprofielRouter from "./basisprofiel";
import trainingFormsRouter from "./training-forms";
import planSlotsRouter from "./plan-slots";
...
router.use("/season-plan", seasonPlanRouter);
router.use("/rhythm", rhythmRouter);
router.use("/wedstrijddoel", basisprofielRouter);
router.use("/training-forms", trainingFormsRouter);
router.use("/plan", planSlotsRouter);
...
// SPARKI_BUILD_01 F10 (PD-3): centrale contacten- en relatielaag (beheer-only).
