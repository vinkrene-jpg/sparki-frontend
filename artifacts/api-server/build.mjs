...
const ALL_ENTRIES = [
      ...
      path.resolve(artifactDir, "src/tests/koppellijst-workouts.ts"),
      path.resolve(artifactDir, "src/tests/data-trust.ts"),
      ...
      path.resolve(artifactDir, "src/scripts/seed-demo-club.ts"),
      ...
      path.resolve(artifactDir, "src/tests/plan-execution.ts"),
